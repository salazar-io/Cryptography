...
def bulk_encrypt(input_dir: str, output_parent_dir: str) -> None:
    ...
    # 2. Iterar sobre los archivos en la carpeta de texto claro
    files_processed = 0
    for filename in os.listdir(input_dir):
        ...
        if os.path.isfile(file_path):
            ...
            # Generar una nueva llave para cada archivo
            key_path = os.path.join(container_path, f"{filename}.key")
...
if __name__ == "__main__":
    try:
        bulk_encrypt(input_dir="plaintext", output_parent_dir="encrypted_vault")
